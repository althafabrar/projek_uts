                ...
                <div class="position-absolute top-50 start-50 translate-middle text-center">
                                ...
                                <div class="card bg-light text-dark shadow">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center">
                                            <img class="img-fluid rounded-circle mb-3" width="500" height="200" src="<?php echo e(Vite::asset('resources/images/profile sementara.jpg')); ?>" alt="image">
                                        </div>
                    ...
                    <div class="col-md-4 offset-md-4 mt-4">
                        <div class="d-grid gap-2">
                            <a class="btn btn-dark bi bi-house-check-fill mt-2 me-2" href="<?php echo e(route('home')); ?>"> Home</a>
                        </div>
                    </div>
                </div>
            </div>
